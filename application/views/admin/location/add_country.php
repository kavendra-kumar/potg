                ...
                <div class="form-group">                    
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="code" placeholder="Country Code" maxlength="5" required>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                            <label>Mobile Number Length</label>
                            <input type="text" pattern="\d*" class="form-control" name="phone_length" placeholder="Mobile Number Length" maxlength="2" required>
                        </div>
                    </div>
                </div>
