...
<main>
  ...
  <div class="contents cropped item-block" data-at="image-cropp">
      <img class="item-content-box item-block image " data-at="image" alt="" src="../<?php echo $info->s2_image ?>">
  </div>
</div>
...
<?php echo form_close(); ?>
  ...
  <div class="contents">
    <p class="x_26743634 x_bc7e314d"></p><p class="x_70ee4658 x_dc6c6e10"><span class="x_80c53a0c"><a href="#" data-toggle="modal" data-target="#terms_condition" class="url-link"><?php echo $info->terms_condition_heading ?>, please CLICK HERE.</a></span></p>
  </div>
</div>
...
popupWhatsApp = () => {
  ...
  let relmsg = msg.replace(/ /g,"%20");    
   window.open('https://api.whatsapp.com/send?phone=+971503053145&text=<?php echo str_replace("&", "", $product->title); ?> - <?php echo generate_product_url($product); ?>  %0D%0A'+relmsg, '_blank'); 
