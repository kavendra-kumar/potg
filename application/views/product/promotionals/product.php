...
<?php $this->load->view("partials_promotionals/_modal_send_message", ["subject" => $product->title]); ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-md-12">
				<img class="top-brand-img" data-at="image" alt="" src="../../<?php echo $info->image_brand; ?>">
			</div>
		</div>
		<div class="section-1">
			<div class="row">
				<div class="col-12 col-md-6 order-1 order-md-0">
					<h1 class="main-title"><?php echo $info->s1_heading; ?></h1>
				...
				<div class="col-12 col-md-6 order-3">
					<div id="element-302">
						<p><?php if($lang == 'en') { echo "This offer will expire in:"; } else { echo "سينتهي هذا العرض خلال";} ?></p>
			...
			<div class="add-space-padding py-md-0">
				<div class="row align-items-center text-center">
					<div class="col-6 col-md-2">
						<img class="certified-img" alt="certified" src="../../uploads/promotions/51205648-0-German.png">
					</div>
					<div class="col-6 col-md-2">
						<img class="certified-img small" alt="certified" src="../../uploads/promotions/51205643-0-CE.png">
					</div>
					<div class="col-6 col-md-2">
						<img class="certified-img" alt="certified" src="../../uploads/promotions/51205638-0-Money-Back.png">
					</div>
					<div class="col-6 col-md-2">
						<img class="certified-img small" alt="certified" src="../../uploads/promotions/51205633-0-RoHS.png">
					</div>
					<div class="col-6 col-md-2">
						<img class="certified-img small" alt="certified" src="../../uploads/promotions/51205623-0-FC.png">
					</div>
					<div class="col-6 col-md-2">
						<img class="certified-img" alt="certified" src="../../uploads/promotions/51205618-0-Warranty.png">
					</div>
				</div>
			</div>
			<div class="add-space-padding" style="background-image:url(../../<?php echo $info->s2_image ?>);background-repeat: no-repeat;background-size: cover;">
				<div class="row">
					<div class="col-12 col-md-6">
						<h2 class="main-last-title"><?php echo $info->s2_heading; ?></h2>
					</div>
				</div>
			</div>
		</div>
		<div class="section-2 add-space-padding">
				...
				<div class="col-12 col-md-4">
					<div class="row">
						<div class="col-4 col-md-6 col-lg-12">
							...
							<p class="section-2-number-text"><?php echo $info->s3_sub_text_1; ?></p>
						</div>
						<div class="col-4 col-md-6 col-lg-12">
							<p class="section-2-number"><?php echo $info->s3_sub_number_2 ?></p>
							<p class="section-2-number-text"><?php echo $info->s3_sub_text_2; ?></p>
						</div>
						<div class="col-4 col-md-12 col-lg-12">
							<p class="section-2-number"><?php echo $info->s3_sub_number_3 ?></p>
							<p class="section-2-number-text"><?php echo $info->s3_sub_text_3; ?></p>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6 col-lg text-center text-lg-left">
					<img class="section-2-img" alt="details" src="../../<?php echo $info->s3_main_image_1 ?>">
					<p class="section-2-msg"><?php echo $info->s3_main_text_1; ?></p>
				</div>
				<div class="col-6 col-lg text-center text-lg-left">
					<img class="section-2-img" alt="details" src="../../<?php echo $info->s3_main_image_2 ?>">
					<p class="section-2-msg"><?php echo $info->s3_main_text_2; ?></p>
				</div>
				<div class="col-12 col-lg text-center text-lg-left">
					<img class="section-2-img" alt="details" src="../../<?php echo $info->s3_main_image_3 ?>">
					<p class="section-2-msg"><?php echo $info->s3_main_text_3; ?></p>
				</div>
				<div class="col-6 col-lg text-center text-lg-left">
					<img class="section-2-img" alt="details" src="../../<?php echo $info->s3_main_image_4 ?>">
					<p class="section-2-msg"><?php echo $info->s3_main_text_4; ?></p>
				</div>
				<div class="col-6 col-lg text-center text-lg-left">
					<img class="section-2-img" alt="details" src="../../<?php echo $info->s3_main_image_5 ?>">
					<p class="section-2-msg"><?php echo $info->s3_main_text_5; ?></p>
				</div>
			</div>
		</div>
		<div class="section-3">
			<div class="row align-items-center">
				<div class="col-12 col-md-7">
					<div class="add-space-padding">
						<h2 class="section-3-title"><?php echo $info->s4_heading; ?></h2>
					</div>
				</div>
				<div class="col-12 col-md-5">
					<div class="add-space-padding">
						<?php echo $info->s4_details; ?>
					</div>
		...
		<div class="section-4 add-space-padding pb-3">
			<h2><?php echo $info->s5_heading; ?></h2>
			<img class="results-img" alt="results" src="../../<?php echo $info->s5_image ?>" />
		</div>
		<div class="section-5 add-space-padding">
			<div class="row">
				...
				<div class="row">
				<div class="col-12 col-md-4 order-0 order-md-0">
					<img class="reviewer" alt="reviewer 1" src="../../<?php echo $info->s6_review_image_1 ?>"/>
				</div>
				<div class="col-12 col-md-8 align-self-center order-1 order-md-1">
					...
					<p class="review-msg mt-3"><?php echo $info->s6_review_comment_1; ?></p>
					<img class="rating" alt="rating" src="../../uploads/promotions/51163118-0-5star.png"/>
				</div>
				<div class="col-12 col-md-8 align-self-center text-right order-3 order-md-2">
					...
					<p class="review-msg mt-3"><?php echo $info->s6_review_comment_2; ?></p>
					<img class="rating float-none" alt="rating" src="../../uploads/promotions/51163123-0-4star.png"/>
				</div>
				<div class="col-12 col-md-4 order-2 order-md-3">
					<img class="reviewer" alt="reviewer 2" src="../../<?php echo $info->s6_review_image_2 ?>"/>
				</div>
				<div class="col-12 col-md-4 order-4 order-md-4">
					<img class="reviewer" alt="reviewer 3" src="../../<?php echo $info->s6_review_image_3 ?>"/>
				</div>
				<div class="col-12 col-md-8 align-self-center order-5 order-md-5">
					...
					<p class="review-msg mt-3"><?php echo $info->s6_review_comment_3; ?></p>
					<img class="rating" alt="rating" src="../../uploads/promotions/51163128-0-45star.png"/>
				</div>
		...
		<div class="section-5-1">
			<div class="row justify-content-center">
				<div class="col-12 col-lg-10">
					<img class="results-img" alt="results-img" src="../../<?php echo $info->s6_review_image ?>"/>
				</div>
			</div>
		</div>
		<div class="section-6">
			<div class="row">
				<div class="col-12 col-md-7">
					<img class="cross-prod-big" alt="cross sale product" src="../../<?php echo $info->s7_image ?>"/>
				</div>
				<div class="col-12 col-md-5">
					<p class="pt-4"></p>
					<p class="cross-prod-name"><?php echo $info->s7_heading ?></p>

					<p class="cross-prod-details"><?php echo $info->s7_details; ?></p>
		...
		<div class="section-6-1 add-space-padding">
			<h2><?php echo $info->s8_heading; ?></h2>
		</div>
		<div class="section-7">
			<div class="row">
				<div class="col-12 col-md-12">
					<div class="add-space-padding pb-0">
						<p><?php echo $info->s9_details; ?></p>
					</div>
				</div>
				<div class="col-12 col-md-7">
					<div class="add-space-padding">
					...
					<?php }?>
						<h2><?php echo $info->s9_heading; ?></h2>
						<div class="contents">
				...
				<div class="col-12 col-md-5">
					<div class="" style="background:url(../../<?php echo $info->s9_image ?>);height: 100%;background-repeat: no-repeat;background-size: cover;"></div>
				</div>
			</div>
		</div>
				...
				<div class="col-12 col-md-6">
					<div class="row align-items-center text-center">
						<div class="col-6 col-md col-lg-6">
							<img class="certified-img" src="../../uploads/promotions/51209298-0-Asset-8.png"/>
						</div>
						<div class="col-6 col-md col-lg-6">
							<img class="certified-img" src="../../uploads/promotions/51209288-0-Asset-10.png"/>
						</div>
						<div class="col-6 col-md col-lg-4">
							<img class="certified-img small" src="../../uploads/promotions/51209283-0-Asset-11.png"/>
						</div>
						<div class="col-6 col-md col-lg-4">
							<img class="certified-img small" src="../../uploads/promotions/51209278-0-Asset-12.png"/>
						</div>
						<div class="col-12 col-md col-lg-4">
							<img class="certified-img small" src="../../uploads/promotions/51209273-0-Asset-13.png"/>
						</div>
					</div>
				</div>
				<div class="col-12 col-md-6">
					<img class="brand-img" src="../../<?php echo $info->image_brand ?>"/>
					<?php if($lang == 'en') { ?>
					...
					<p>ليس بالمشكلة</p>
					<?php } ?>
					<p><?php echo $info->s10_description; ?></p>
					<ul>
						<li><?php echo $info->s10_point_1; ?></li>
						<li><?php echo $info->s10_point_2; ?></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-12 col-md-6">
					...
					<div class="img-wrapper">
						<img class="product-img" alt="product image" src="../../<?php echo $info->s1_product_image ?>"/>
						
						<?php if($info->s11_cross_sale_image){ ?>
						<img class="cross-product-img" alt="Cross product image" src="../../<?php echo $info->s11_cross_sale_image ?>"/>
						<?php } ?>
					</div>
					<h2 class="product-name"><?php echo $info->s11_product_title; ?></h2>
				...
				<div class="col-12 col-md-6">
					<div class="card card-body h-100" id="add_to_cart" >
									...
									<div class="row row-product-variation item-variation">
										<?php if (!empty($full_width_product_variations)):
											foreach ($full_width_product_variations as $variation):
												$this->load->view('product/promotionals/_product_variations', ['variation' => $variation]);
											endforeach;
										endif;
						...
						<?php // print_r($product); ?> 
						<div class="row">
							<div class="col-12"><?php $this->load->view('product/promotionals/_messages'); ?></div>
						</div>
						<div class="row">
						...
						<div class="row pt-4">
							<div class="col">
								<?php if($lang == 'en'){echo "-CASH ON DELIVERY-";}else{echo "الدفع نقداً عند التسليم";} ?>
								<p>
								<?php 
							...
							<div class="col">
								<div class="text-right">
									<img class="cod-img" alt="COD" src="../../uploads/promotions/51151028-0-COD.png">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="section-10 add-space-padding py-3">
			<div class="row align-items-center text-center">
				<div class="col-12 col-md-6 text-center">
					<p><?php if($lang == 'en'){echo "HURRY! LIMITED OFFER ONLY!";}else{echo "أسرعوا ! يسري العرض <br>حتى نفاد الكمية";} ?></p>
				</div>
				<div class="col-12 col-md-6">
				<div id="element-302">
					<div class="timer timer-text-bottom item-block">
		...
		<div class="section-10 add-space-padding text-center py-md-3">
			<a href="#" data-toggle="modal" data-target="#faq_modal" class="url-link"><?php echo $info->faq_heading; ?></a>
		</div>
		<div class="section-10 add-space-padding text-center py-md-3">
			<a href="#" data-toggle="modal" data-target="#terms_condition" class="url-link"><?php echo $info->terms_condition_heading; ?></a>
		</div>
	</div>
</div>
