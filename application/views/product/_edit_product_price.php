                    ...
                    <div class="col-12 col-sm-4 m-b-sm-15">
						<label class="control-label">Currency</label>
								<div class="input-group">
                                    <select name="currency" class="form-control" id="product-currency-selector" required>
...
<script>
	...
	$("#product-currency-selector").change(function(){
		setCurrency();
	});
	$("#product_price_input_variation").keyup(function(){
		setCurrency();
	});
	function setCurrency(){
		var currency = $("#product-currency-selector").val();
