                        ...
                        <div class="col-12 col-md-12 col-lg-11">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <?php if (!empty($custom_field_array) || ($this->form_settings->product_conditions == 1 && $product->product_type == 'physical') || ($this->form_settings->quantity == 1)): ?>
                                        <div class="form-box">
                                            <div class="form-box-head">
                                                ...
                                                <?php if ($product->product_type == 'physical'): ?>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <?php if ($product->listing_type != 'ordinary_listing' && $this->form_settings->quantity == 1) : ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <?php if ($this->form_settings->quantity == 1) : ?>
                                                                <div class="col-12 col-sm-6">
                                                                    <label class="control-label"><?php echo trans('stock'); ?></label>
                                                                    <input type="number" name="stock" id="input_stock" class="form-control form-input <?php echo ($product->stock_unlimited == 1) ? 'display-none' : ''; ?>" min="0" max="999999999" value="<?php echo $product->stock; ?>" placeholder="<?php echo trans("stock"); ?>" <?php echo ($this->form_settings->quantity_required == 1) ? 'required' : ''; ?>>
                                                                    <div class="custom-control custom-checkbox m-t-15">
                                                                        <input type="checkbox" class="custom-control-input" name="stock_unlimited" id="checkbox_unlimited_stock" value="1" <?php echo ($product->stock_unlimited == 1) ? 'checked' : ''; ?>>
                                                                        <label for="checkbox_unlimited_stock" class="custom-control-label"><?php echo trans("unlimited_stock"); ?></label>
                                                                    </div>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                    ...
                                    <script>
                                        $(document).on('change', '#checkbox_unlimited_stock', function () {
                                            if (!this.checked) {
                                                $("#input_stock").show();
                                            } else {
                                                $("#input_stock").hide();
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6 m-t-15 shipping-cost-container" style="<?php echo ($this->settings_model->is_shipping_option_require_cost($product->shipping_cost_type) == 1) ? 'display:block;' : ''; ?>">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <?php endif; ?>
                                                                <input type="text" name="shipping_cost" aria-describedby="basic-addon3" class="form-control form-input price-input" value="<?php echo $product->shipping_cost != 0 ? get_price($product->shipping_cost, 'input') : ''; ?>" placeholder="<?php echo $this->input_initial_price; ?>" onpaste="return false;" maxlength="32" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 m-t-15 shipping-cost-container" style="<?php echo ($this->settings_model->is_shipping_option_require_cost($product->shipping_cost_type) == 1) ? 'display:block;' : ''; ?>">
