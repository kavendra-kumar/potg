...
<header id="header">
    <?php $this->load->view("partials_promotionals/_top_bar"); ?>
    <div class="main-menu">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="nav-main">
                    <!--main navigation-->
                    <?php $this->load->view("partials_promotionals/_main_nav"); ?>
                </div>
            </div>
        </div>
    </div>
...
<!--include mobile menu-->
<?php $this->load->view("partials_promotionals/_mobile_nav"); ?>
                ...
                <div class="auth-box">
                    ...
                    <form id="form_login" novalidate="novalidate">
                        <div class="social-login-cnt">
                            <?php $this->load->view("partials_promotionals/_social_login", ["or_text" => trans("login_with_email")]); ?>
                        </div>
