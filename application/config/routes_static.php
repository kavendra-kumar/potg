...
$route['cod-direct-post']['POST'] = 'cart_controller/cod_direct_post';
...
$route['edit-product-promotions-info-post']['POST'] = 'product_controller/edit_product_promo_info_post';
...
$route['add-to-newsletter-post']['POST'] = 'home_controller/add_to_newsletter';
