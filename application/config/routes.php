...
/*slider routes*/
$route[$routes->admin . '/promocode'] = 'admin_controller/promocode';
$route[$routes->admin . '/validatepromocode/(:any)'] = 'admin_controller/validatepromocode/$1';
$route[$routes->admin . '/add_promocode'] = 'admin_controller/add_promocode';

$route[$routes->admin . '/delete_promocode'] = 'admin_controller/delete_promocode';
...
$route[$routes->admin . '/product_variations/(:num)'] = 'order_admin_controller/product_variations/$1';
...
$route[$routes->admin . '/add_product_to_existingorder'] = 'order_admin_controller/add_product_to_existingorder';
