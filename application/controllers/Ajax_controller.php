...
class Ajax_controller extends Home_Core_Controller
{
    ...
    */
    ...
    //set country from IP 
    public function set_country_ip()
    {	
		$location_id = $_POST['country_code'];
    ...
    */
    ...
    //get cross sale products details
    public function get_cross_sale()
    {
		$ids = json_encode($_POST['ids']);
		$result = $this->product_model->get_cross_sales_list($ids);
		print_r($result);
    }
    /*
    *------------------------------------------------------------------------------------------
